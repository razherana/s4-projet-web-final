  ...
  <div class="col-md-8">
    <div class="card">
      <div class="card-header">
        <h5 class="card-title">Créer un Type de Prêt</h5>
      </div>
      <div class="card-body">
        <form method="POST" action="<?= route('/type-prets') ?>">
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="number" step="0.01" class="form-control" id="taux_interet" name="taux_interet" required>
          </div>
          ...
          <div class="mb-3">
            ...
            <input type="number" class="form-control" id="duree_max" name="duree_max" required>
          </div>
